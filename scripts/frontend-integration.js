 ...
 * This file demonstrates how to integrate Tidevault with a web frontend
 */

// For React/Vue/Angular applications
export class TidevaultClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TidevaultClient(provider, contractAddress);
